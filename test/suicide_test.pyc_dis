#Embedded file name: /Users/bh/programs/robot/rgkit/test/suicide_test.py
import base
import unittest
from bots import *
...
class SuicideTest(base.BaseTestCase):
    ...
    def test_basic_suicide(self):
        _, (bot2,) = self.simulate([RobotSuicide, RobotGuard], [(10, 10)], [], [(11, 10)], [(11, 10)])
